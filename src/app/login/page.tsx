...
export default function Component() {
  ...
  return (
    <>
      <div className="grid gap-5 min-h-screen h-screen bg-gradient-to-b from-[#015DE7] to-[#061388] px-4 sm:px-6 lg:px-8 place-content-center overflow-hidden">
  ...
  <div className="flex flex-col items-center justify-center overflow-hidden">
    ...
    >
      ...
      <Image
        ...
        width={457}
        height={156}
        className="w-[150px] sm:w-[200px] md:mt-[-7.5rem] mt-[-3rem]  md:w-[250px] lg:mt-[-7rem] lg:ml-[1rem] lg:w-[300px] h-[6rem] sm:h-[8rem] md:h-[15rem] lg:h-[12rem]" 
      />
    </div>
  </div>
  ...
  <div className="flex justify-center overflow-hidden">
    <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg shadow-md w-full max-w-[25rem] sm:max-w-md lg:max-w-lg overflow-hidden"> 
      <div className="flex items-center mb-6">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold">Log In</h1>
      </div>
